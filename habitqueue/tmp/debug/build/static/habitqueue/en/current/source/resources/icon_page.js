    ...
    value: function() {  
      ...
      function generateIcons(iconSize, iconNames) {
        ...
        iconNames.forEach(function(k) {
          ret.push('<div class="icon"><div class="inner"><img src="%@" class="icon sc-icon-%@-%@" style="height: %@px; width: %@px; position: relative" /></div><label>sc-icon-%@-%@</label></div>'.fmt('/static/sproutcore/foundation/en/current/blank.gif?1296877287', k, iconSize, iconSize, iconSize, k, iconSize)) ;
        });
